...
class AccessControlSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'Cancel Orders', 'slug' => 'orders.cancel', 'group' => 'orders', 'is_sensitive' => false],
            ['name' => 'Cancel In-Production Orders', 'slug' => 'orders.cancel_in_production', 'group' => 'orders', 'is_sensitive' => true],
            ['name' => 'Cancel Ready to Ship Orders', 'slug' => 'orders.cancel_ready_to_ship', 'group' => 'orders', 'is_sensitive' => true],
