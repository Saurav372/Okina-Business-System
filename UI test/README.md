...
2. Test and compare the designs here without changing the Laravel storefront under `resources/`.
3. Put reusable images, icons, and fonts in `shared-assets/`.
4. Keep screenshots and visual inspiration in `references/`.
5. After choosing a design, recreate the approved version in the Laravel
   storefront under `resources/`.

## Rules

- Do not import production code from `resources/` into a UI concept.
...
- Treat this folder as experimental; only the chosen design moves to production.
