...
2. Test and compare the designs here without changing the Laravel storefront under `apps/backend/resources`.
...
5. After choosing a design, recreate the approved version in the Astro
   storefront under `apps/backend/resources`.

## Rules

- Do not import production code from `apps/backend/resources` into a UI concept.
