...
| U1.1.4 | SearchBox | Foundation | 1 | Search input with debounce. | U1.1.1 | Completed |
| U1.1.5 | DatePicker | Foundation | 1 | Date selection component. | U1.1.1 | Completed |
| U1.1.6 | FileUpload | Foundation | 1 | File upload with preview. | U1.1.1 | Completed |
| **U1.2** | **Data & Table** | Foundation | 1 | **Milestone** | U0.5 | Milestone |
| U1.2.1 | DataTable | Foundation | 1 | Table with sorting/columns. | U0.5 | Completed |
...
| U1.3.3 | Dropdown | Foundation | 1 | Context menu dropdown. | U0.5 | Completed |
