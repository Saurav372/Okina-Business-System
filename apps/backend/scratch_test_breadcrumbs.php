...
$def = new \App\Support\Breadcrumbs\BreadcrumbDefinition();
$builder = new \App\Support\Breadcrumbs\BreadcrumbBuilder($def);

echo "5. Dynamic (admin.sales_orders.show with {order.public_id})\n";
$order = new class { public $public_id = 'ORD-2026-999'; };
...
$mockDef = new class extends \App\Support\Breadcrumbs\BreadcrumbDefinition {
...
$log = new class { public $id = 'LOG-123'; };
