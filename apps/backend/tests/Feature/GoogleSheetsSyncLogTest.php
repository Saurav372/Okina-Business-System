...
class GoogleSheetsSyncLogTest extends TestCase
{
    ...
    {
        // 1. Create a lead. Disable sync during factory creation to avoid auto-firing.
        Config::set('sheets.enabled', false);
        $lead = Lead::factory()->create(['contact_name' => 'Test Lead']);
        ...
        $job = new SyncRecordToGoogleSheetsJob(Lead::class, $lead->id, $log->id);
    ...
    public function test_subsequent_saves_create_new_logs(): void
    {
        ...
        $job1 = new SyncRecordToGoogleSheetsJob(Lead::class, $lead->id, $log1->id);
        $this->app->call([$job1, 'handle']);

        // Update lead. Disable sync during update to avoid auto-firing.
        Config::set('sheets.enabled', false);
        $lead->update(['contact_name' => 'Updated Name']);
        Config::set('sheets.enabled', true);
        ...
        $job2 = new SyncRecordToGoogleSheetsJob(Lead::class, $lead->id, $log2->id);
