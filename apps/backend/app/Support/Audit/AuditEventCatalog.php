...
final class AuditEventCatalog
{
    ...
    public function definitions(): array
    {
        return [
            ...
            new AuditEventDefinition(
                key: 'customers.customer_updated',
                module: 'customers',
                action: 'customer.updated',
                subjectType: 'customer',
                actorTypes: ['user', 'system'],
                safeFields: ['customer_public_id', 'customer_type', 'status', 'source', 'accepts_marketing'],
                maskedFields: ['email', 'phone', 'whatsapp_phone', 'first_name', 'last_name', 'company_name', 'display_name', 'password', 'token'],
                relatedTypes: [],
                references: ['A3.1', 'C6.1.3'],
                summary: 'Customer profile was updated by staff or system.',
            ),
            new AuditEventDefinition(
                ...
                subjectType: 'product',
                actorTypes: ['user', 'system'],
                safeFields: ['product_slug', 'product_type', 'status', 'visibility', 'customization_mode', 'fulfillment_type', 'min_order_quantity', 'max_order_quantity', 'base_price_minor', 'currency', 'sort_order'],
                maskedFields: ['description', 'short_description', 'seo_title', 'seo_description', 'raw_payload'],
                relatedTypes: [],
                references: ['A3.2', 'C6.1.3'],
                summary: 'Product configuration or catalog details were updated.',
            ),
            new AuditEventDefinition(
                key: 'products.sku_updated',
                module: 'products',
                action: 'sku.updated',
                subjectType: 'product_sku',
                actorTypes: ['user', 'system'],
                safeFields: ['sku_code', 'status', 'direct_checkout_enabled', 'quote_required', 'track_stock', 'price_minor', 'compare_at_price_minor', 'allow_backorder', 'low_stock_threshold', 'sort_order'],
                maskedFields: ['barcode', 'option_values', 'raw_payload'],
            ...
            new AuditEventDefinition(
                ...
                subjectType: 'user',
                actorTypes: ['user', 'system'],
                safeFields: ['role_slug', 'role_name', 'assigned_by_user_id'],
                maskedFields: ['email', 'password', 'token', 'raw_payload'],
                relatedTypes: ['role'],
                references: ['A2.3', 'C6.1.3'],
                summary: 'A role was assigned to a staff user.',
            ),
            new AuditEventDefinition(
                key: 'users.permission_updated',
                module: 'users',
                action: 'permission.updated',
                subjectType: 'user',
                actorTypes: ['user', 'system'],
                safeFields: ['roles_synced', 'assigned_by_user_id'],
                maskedFields: ['email', 'password', 'token', 'raw_payload'],
                relatedTypes: [],
                references: ['A2.3', 'C6.1.3'],
